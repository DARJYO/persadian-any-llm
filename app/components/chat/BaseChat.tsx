          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                 <img src="https://github.com/DARJYO/persadian-llm/blob/main/public/logo-light-styled.png" align="center" height="100%" width="100%">   
                ...
                <h6>© 2025 DARJYO. All Rights Reserved.</h6>
              </div>
            )}
            <div
                ...
                >
                  ...
                  >
                    <textarea
                      ...
                      placeholder="How can our PERSADIAN-LLM help you today?"
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
